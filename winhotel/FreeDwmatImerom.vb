    ...
    Private Sub FreeDwmatImeromBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles FreeDwmatImeromBtn.Click
        ...
        Try
            ...
            ElseIf klinesKwd = 0 And tiposKwd = 0 Then
                Me.DwmatiaTableAdapter.FillDwmatiaOlwnKatigoriwn(Me.DbhotelDataSet.dwmatia, 19, 27)
            ElseIf klinesKwd <> 0 And tiposKwd = 0 Then
                Me.DwmatiaTableAdapter.FillDwmatiaByKlines(Me.DbhotelDataSet.dwmatia, klinesKwd, 19, 27)
            ElseIf klinesKwd = 0 And tiposKwd <> 0 Then
