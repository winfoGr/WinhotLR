...
Public Class ExtraParastatika
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.ExtraParastatika.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedExtraParastatika
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ExtraParastatika = New ExtraParastatika()
        rpt.Site = Me.Site
        Return rpt
    End Function
