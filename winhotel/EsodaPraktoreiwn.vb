...
Public Class EsodaPraktoreiwn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.EsodaPraktoreiwn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEsodaPraktoreiwn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EsodaPraktoreiwn = New EsodaPraktoreiwn()
        rpt.Site = Me.Site
        Return rpt
    End Function
