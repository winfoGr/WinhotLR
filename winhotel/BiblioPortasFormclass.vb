...
Public Class BiblioPortasFormclass
    ...
    Dim index As Byte
    'index0 ola 1=europe 2 koutsourakis
    Public Sub New(ByVal imerominia As Date, ByVal timOK As Boolean, ByVal theorOK As Boolean, ByVal flag As Byte, ByVal indx As Byte)
    ...
    Public Function biblPortas() As Boolean
            ...
            Try
                ...
                For j = 0 To Me.DbhotelDataSet.katastasiapy.Count - 1
                    ...
                    If kwdTemp <> Me.DbhotelDataSet.katastasiapy(j).kwd Then 'parolatauta tsekarisma!!
                        ...
                        If Me.DbhotelDataSet.katastasiapy(j).ypnos <> myReader.Item("ypnos") OrElse Me.DbhotelDataSet.katastasiapy(j).prwino <> myReader.Item("prwino") OrElse
                        (Me.DbhotelDataSet.katastasiapy(j).geuma + Me.DbhotelDataSet.katastasiapy(j).deipno) <> myReader.Item("geumata") OrElse Me.DbhotelDataSet.katastasiapy(j).extra <> myReader.Item("extras") OrElse
                        Me.DbhotelDataSet.katastasiapy(j).xrewsikwd <> myReader.Item("xrewsi") Then
                            ...
                            "praktoreio, ypnos, prwino, geumata, extras, synolo, arapy, datum, paratiriseis, flag) values (@etos, @imerominia, @status, @kratisi, @voucher, @dwmatio, @enilikes, @anilika, @atoma," &
                ...
                For j = 0 To Me.DbhotelDataSet.kratiseis.Count - 1
                    ...
                    If myReader.Item("imerominia") <> imeromErgasias OrElse (myReader.Item("imerominia") = imeromErgasias And myReader.Item("parastatiko") = 0) Then
                        ...
                        command.CommandText = "INSERT INTO biblioportas (etos, imerominia, status, kratisi, voucher, dwmatio, enilikes, anilika, atoma, xrewsi, onomateponimo, anzethnikotita, ethnikotita, anzethnikotita2, ethnikotita2, praktoreio, ypnos, prwino, geumata, extras, synolo, arapy, datum, paratiriseis, flag, parastatiko) VALUES (@etos, @imerominia, @status, @kratisi, @voucher, @dwmatio, @enilikes, @anilika, @atoma, @xrewsi, @onomateponimo, @anzethnikotita, @ethnikotita, @anzethnikotita2, @ethnikotita2, @praktoreio, @ypnos, @prwino, @geumata, @extras, @synolo, @arapy, @datum, @paratiriseis, 0, @parastatiko)"
                        myReader.Close()
                        command.ExecuteNonQuery()
                        command.Parameters.Clear()
                        ...
                        If Me.DbhotelDataSet.kratiseis(j).ekptosi Then
                            ...
                            command.CommandText = "INSERT INTO biblioportas (etos, imerominia, status, kratisi, onomateponimo, ypnos, geumata, extras, synolo, arapy, paratiriseis, flag, parastatiko) " &
                        ...
                        If Me.DbhotelDataSet.kratiseis(j).dwmatio.Equals("Ov-Book") Then
                            ...
                            command.Parameters.AddWithValue("@kratisi", CType(Me.DbhotelDataSet.kratiseis(j).kwd, Integer))
                            command.CommandText = "UPDATE over SET mexri=@mexri, epistrofiOK=1 where kratisi=@kratisi and epistrofiOK=0"
                        ...
                        command.CommandText = "UPDATE kratiseis SET checkout=1 where (kwd=@kwd)"
                        rows = command.ExecuteNonQuery()
                        command.Parameters.Clear()
        ...
        Else
            If index = 1 Then
                Me.BiblioportasTableAdapter.FillBiblioByTipos(Me.DbhotelDataSet.biblioportas, imeromErgasias, 17, 21)
            ElseIf index = 2 Then
                Me.BiblioportasTableAdapter.FillBiblioByTipos(Me.DbhotelDataSet.biblioportas, imeromErgasias, 13, 16)
            ElseIf index = 0 Then
    ...
    Private Sub dynami_berechnen()
        ...
        'query mit xrewsi<>0
        If index = 0 Then
            Me.BiblioportasTableAdapter.FillBiblioportasBisEtos2TagTipos(Me.DbhotelDataSet.biblioportas, etos, imeromErgasias, 0, False, 0, 21, etos, imeromErgasias, 0, imeromErgasias, 0, 21)
        ElseIf index = 1 Then
            Me.BiblioportasTableAdapter.FillBiblioportasBisEtos2TagTipos(Me.DbhotelDataSet.biblioportas, etos, imeromErgasias, 0, False, 17, 21, etos, imeromErgasias, 0, imeromErgasias, 17, 21)
        ElseIf index = 2 Then
            Me.BiblioportasTableAdapter.FillBiblioportasBisEtos2TagTipos(Me.DbhotelDataSet.biblioportas, etos, imeromErgasias, 0, False, 13, 16, etos, imeromErgasias, 0, imeromErgasias, 13, 16)
        End If
    ...
    End Sub
    Private Sub apo_metafora(ByVal startIndex As Int16, ByVal countIndex As Int16, ByRef dwm As Int16, ByRef enl As Int16,
    ByRef paid As Int16, ByRef atom As Int16, ByRef rr As Int16, ByRef bb As Int16, ByRef hb As Int16, ByRef fb As Int16, ByRef ai As Int16,
    ByRef ypnos As Single, ByRef prwina As Single, ByRef geumata As Single, ByRef extras As Single, ByRef synolo As Single)
        ...
        Next
    End Sub
    Private Sub dynami_afixeis(ByVal startIndex As Int16, ByRef dwm As Int16, ByRef enl As Int16,
   ByRef paid As Int16, ByRef atom As Int16, ByRef rr As Int16, ByRef bb As Int16, ByRef hb As Int16, ByRef fb As Int16, ByRef ai As Int16,
   ByRef ypnos As Single, ByRef prwina As Single, ByRef geumata As Single, ByRef extras As Single, ByRef synolo As Single)
        ...
        Next
    End Sub
    Private Sub dynami_anaxwriseis(ByVal startIndex As Int16, ByRef dwm As Int16, ByRef enl As Int16,
  ByRef paid As Int16, ByRef atom As Int16, ByRef rr As Int16, ByRef bb As Int16, ByRef hb As Int16, ByRef fb As Int16, ByRef ai As Int16,
  ByRef ypnos As Single, ByRef prwina As Single, ByRef geumata As Single, ByRef extras As Single, ByRef synolo As Single)
    ...
    Private Sub proepiskopisi_biblioportas()
        ...
        If index = 0 Then
            ektiposi.SetParameterValue("onoma", "ΓΕΝΙΚΑ")
        ElseIf index = 1 Then
            ektiposi.SetParameterValue("onoma", "HOUSE OF EUROPE")
        ElseIf index = 2 Then
            ektiposi.SetParameterValue("onoma", "KOUTSOURAKIS")
        End If
