...
Public Class ParametroiF
    ...
    Private Sub TreeView1_AfterSelect(ByVal sender As System.Object, ByVal e As System.Windows.Forms.TreeViewEventArgs) Handles TreeView1.AfterSelect
        ...
        Select Case Me.TreeView1.SelectedNode.Name.ToString
            ...
            Case "StopSales"
                ...
                Me.HauptPnl.BorderStyle = BorderStyle.FixedSingle
                Me.HauptPnl.Dock = DockStyle.Fill
                email_stopsales_settings()
            Case "emailCancel"
                Me.HauptPnl.Controls.Clear()
                Me.HauptPnl.BorderStyle = BorderStyle.FixedSingle
                Me.HauptPnl.Dock = DockStyle.Fill
                email_agencies_cancellation()

            Case "newstoAgencies"
                Me.HauptPnl.Controls.Clear()
                Me.HauptPnl.BorderStyle = BorderStyle.FixedSingle
                Me.HauptPnl.Dock = DockStyle.Fill
                newslleter_agencies_settings()

            Case "toDiamenontes"
                Me.HauptPnl.Controls.Clear()
                Me.HauptPnl.BorderStyle = BorderStyle.FixedSingle
                Me.HauptPnl.Dock = DockStyle.Fill
                email_to_diamenontes()
        End Select
    End Sub
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        Try
            Me.EtaireiaTableAdapter.UpdateLeitourgia(TextBox1.Text, TextBox6.Text, CheckBox1.Checked, CheckBox2.Checked, TextBox3.Text,
    ...
    Private Sub SaveToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles SaveToolStripButton.Click
        ...
        For i = 0 To ParastatikaBindingSource.Count - 1
            ...
            If Me.ParastatikaTableAdapter.ExistKwdiko(ParastatikaDataGridView.Item(0, i).Value) Then
                ...
                Catch ex As InvalidCastException
                    MsgBox("Η Αλλαγή του " + ParastatikaDataGridView.Item(1, i).Value + " δεν κατέστη δυνατή" & vbCrLf &
            ...
            Else
                If Not ParastatikaDataGridView.Item(3, i).Value.ToString.Equals("") Then
                    ...
                    Catch ex As InvalidCastException
                        MsgBox("Η Αποθήκευση του " + ParastatikaDataGridView.Item(1, i).Value + " δεν κατέστη δυνατή:" & vbCrLf &
                        "Ο Αριθμός του Παραστατικού πρεπει να περιέχει μόνο νούμερα!", MsgBoxStyle.Exclamation, "winfo\nikEl.")
    ...
    Private Sub Prwino_komma_einschalten(ByVal sender As System.Object, ByVal e As KeyPressEventArgs) Handles Fpatrofis1TextBox.KeyPress, Fpatrofis2TextBox.KeyPress, Fpatrofis3TextBox.KeyPress, Dimforos1TextBox.KeyPress, Dimforos2TextBox.KeyPress,
    ...
    End Sub
    Private Sub Prwino_click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Fpatrofis1TextBox.Click, Fpatrofis2TextBox.Click, Fpatrofis3TextBox.Click, Dimforos1TextBox.Click, Dimforos2TextBox.Click,
    Fparepid1TextBox.Click, Fparepid2TextBox.Click, Fpatmima1TextBox.Click, Fpatmima2TextBox.Click, Fpatmima3TextBox.Click, Fpatmima4TextBox.Click, ExtrasTextBox.Click
        selectall(sender, e)
    End Sub
    Private Sub FpatrofisTextBox_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles Fpatrofis1TextBox.Leave, Fpatrofis2TextBox.Leave, Fpatrofis3TextBox.Leave,
       Dimforos1TextBox.Leave, Dimforos2TextBox.Leave, Fparepid1TextBox.Leave, Fparepid2TextBox.Leave, Fpatmima1TextBox.Leave,
    ...
    Private Sub Button2_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        Try
            Me.EtaireiaTableAdapter.UpdateFpa(Fpatrofis1TextBox.Text, Fpatrofis2TextBox.Text, Fpatrofis3TextBox.Text,
                    Dimforos1TextBox.Text, Dimforos2TextBox.Text, Fparepid1TextBox.Text, Fparepid2TextBox.Text, Fpatmima1TextBox.Text,
        ...
        For i = 0 To dwmatneu.Length - 1
            If dwmatalt(i) <> dwmatneu(i) AndAlso dwmatalt(i) = "-1" Then
                Try
                    ...
                    enimerosiOK = True
                Catch ex As OleDb.OleDbException
                    MsgBox(ex.ToString, MsgBoxStyle.Exclamation, "winfo\nikEl.")
                End Try
    ...
    Private Sub katigories_zeig()
        ...
        InfoLbl.TextAlign = ContentAlignment.MiddleCenter
        InfoLbl.ForeColor = Color.Black
        InfoLbl.Text = "<Δώστε Max. Κλίνες σε Δωμάτιο και έπειτα πατήστε ENTER!" & vbCrLf & " Δώστε νέο τύπο (θέα) Δωματίου (+ENTER) !" & vbCrLf & "Γιά αλλαγή ονόματος πηγαίνετε στην επικεφαλίδα (+ENTER)" & vbCrLf &
        ...
        If e.KeyChar = Microsoft.VisualBasic.ChrW(Keys.Return) Then
            ...
            Else
                ...
                If CType(Me.KatigoriesTableAdapter.ExistEintrag(kwdikoitipwn(split(1))), Integer) = 0 Then
                    ...
                    End Try
                Else
                    MsgBox(" Για να γίνει Διαγραφή δεν πρεπει να υπάρχουν Δωμάτια  αυτού του τύπου" & vbCrLf &
    ...
    Private Sub KatigTbx_enter(ByVal sender As Object, ByVal e As System.EventArgs)
        MsgBox("Αλλάξτε το ονομα και πατήστε (+ENTER)" & vbCrLf &
        "Διαγράψτε τον τύπο Δωματιου σβήνωντας απλα το ονομα (+ENTER)" & vbCrLf &
    ...
    Private Sub emailBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles emailBtn.Click
        Using connection As New SqlConnection(connectionString)
            ...
            command.CommandText = "UPDATE Mail SET ffrom=@ffrom, subject=@subject, body=@body, attachment=@attachment, smtpServer=@smtpServer, smtpUsername=@smtpUsername, smtpPassword=@smtpPassword WHERE kwd=1"
    ...
    End Sub
    Private Sub email_agencies_cancellation()
        'locy = 2 * EtiketaLbl.Height + 80
        EtiketaPnl.Size = New Point(482, 60) 'Etiketa panel initialisieren
        EtiketaPnl.Controls.Add(EtiketaLbl)
        EtiketaPnl.Location = New Point(5, 5)
        ...
        EtiketaLbl.Text = "Cancellation to agencies"
        EtiketaLbl.Location = New Point(EtiketaPnl.Width / 2 - 100, EtiketaPnl.Height / 2)

        emailCancelPnl.Size = New Point(482, 248)
        emailCancelPnl.Location = New Point(5, EtiketaPnl.Height + 5)
        'emailPnl.Location = New Point(5, 5)
        HauptPnl.Controls.Add(emailCancelPnl)
        fuehle_mail_ag_felder_cancel()
    End Sub
    Private Sub emailagBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles emailagBtn.Click
        ...
        Using connection As New SqlConnection(connectionString)
            ...
            command.Parameters.AddWithValue("@subject", subjectagTbx.Text)
            command.Parameters.AddWithValue("@body", bodyagRTbx.Text)
            command.CommandText = "UPDATE Mail SET subject=@subject, body=@body WHERE kwd=2"

            command.ExecuteNonQuery()
        End Using

    End Sub
    'Private Sub SaveCancBtn_Click(sender As Object, e As EventArgs) Handles SaveCancBtn.Click
    '    Using connection As New OleDb.OleDbConnection(connectionString)
    '        Dim command As New OleDb.OleDbCommand()
    '        'Dim myReader As OleDb.OleDbDataReader
    '        connection.Open()
    '        command.Connection = connection
    '        command.Parameters.AddWithValue("subject", subjectCanc.Text)
    '        command.Parameters.AddWithValue("body", BodyRbx.Text)
    '        command.CommandText = "UPDATE Mail SET subject=?,body=? WHERE (kwd=7)" '  FROM parastatika INNER JOIN afm ON parastatika.etaireia=afm.kwd WHERE (parastatika.kwd=?)" 'and (identifikation=?)
    '        command.ExecuteNonQuery()
    '        ' Always call Read before accessing data.
    '    End Using
    'End Sub
    Private Sub SaveCancBtn_Click(sender As Object, e As EventArgs) Handles SaveCancBtn.Click
        Using connection As New SqlConnection(connectionString)
            ...
            command.Parameters.AddWithValue("@subject", subjectCanc.Text)
            command.Parameters.AddWithValue("@body", BodyRbx.Text)
            command.CommandText = "UPDATE Mail SET subject=@subject, body=@body WHERE kwd=7"
    ...
    End Sub
    Private Sub fuehle_mail_ag_felder_cancel()
        Dim mailadapter As New dbhotelDataSetTableAdapters.MailTableAdapter

        mailadapter.Fill(Me.DbhotelDataSet.Mail)
        subjectCanc.Text = Me.DbhotelDataSet.Mail(6).subject
        BodyRbx.Text = Me.DbhotelDataSet.Mail(6).body
    ...
    Private Sub directionBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles directBtn.Click
        ...
        Using connection As New SqlConnection(connectionString)
            ...
            command.Parameters.AddWithValue("@subject", directSubject.Text)
            command.Parameters.AddWithValue("@body", directBody.Text)
            command.CommandText = "UPDATE Mail SET subject=@subject, body=@body WHERE kwd=3"

            command.ExecuteNonQuery()
        End Using

    End Sub
    Private Sub email_stopsales_settings()
        'locy = 2 * EtiketaLbl.Height + 80
        EtiketaPnl.Size = New Point(482, 60) 'Etiketa panel initialisieren
        EtiketaPnl.Controls.Add(EtiketaLbl)
        EtiketaPnl.Location = New Point(5, 5)
        ...
        EtiketaLbl.Text = "Stop Sales"
        EtiketaLbl.Location = New Point(EtiketaPnl.Width / 2 - 100, EtiketaPnl.Height / 2)

        stopsalesPnl.Size = New Point(482, 248)
        stopsalesPnl.Location = New Point(5, EtiketaPnl.Height + 5)
        'emailPnl.Location = New Point(5, 5)
        HauptPnl.Controls.Add(stopsalesPnl)
        fuehle_stop_sales_felder()
    End Sub
    Private Sub fuehle_stop_sales_felder()
        Dim mailadapter As New dbhotelDataSetTableAdapters.MailTableAdapter

        mailadapter.Fill(Me.DbhotelDataSet.Mail)
        If Me.DbhotelDataSet.Mail.Count >= 3 Then
            stopSalesTbx.Text = Me.DbhotelDataSet.Mail(4).subject
            stopsalesBody.Text = Me.DbhotelDataSet.Mail(4).body
        End If


    End Sub
    Private Sub stopsales_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles stopsalesBtn.Click
        Using connection As New SqlConnection(connectionString)
            Dim command As New SqlCommand()

            connection.Open()
            command.Connection = connection
            command.Parameters.AddWithValue("@subject", stopSalesTbx.Text)
            command.Parameters.AddWithValue("@body", stopsalesBody.Text)
            command.CommandText = "UPDATE Mail SET subject=@subject, body=@body WHERE kwd=5"
    ...
    Private Sub newslleter_agencies_settings()
        ...
        EtiketaLbl.Text = "newsletter to agencies"
        EtiketaLbl.Location = New Point(EtiketaPnl.Width / 2 - 100, EtiketaPnl.Height / 2)
        PraktoreiaPnl.Size = New Point(482, 370)

        PraktoreiaPnl.Location = New Point(5, EtiketaPnl.Height + 5)

        HauptPnl.Controls.Add(PraktoreiaPnl)

    End Sub
    Private Sub email_to_diamenontes()
        'locy = 2 * EtiketaLbl.Height + 80
        EtiketaPnl.Size = New Point(482, 60) 'Etiketa panel initialisieren
        EtiketaPnl.Controls.Add(EtiketaLbl)
        EtiketaPnl.Location = New Point(5, 5)
        ...
        EtiketaLbl.Text = "e-MAIL to residents"
        EtiketaLbl.Location = New Point(EtiketaPnl.Width / 2 - 100, EtiketaPnl.Height / 2)

        DiamEmailPnl.Size = New Point(482, 303)
        DiamEmailPnl.Location = New Point(5, EtiketaPnl.Height + 5)
        'emailPnl.Location = New Point(5, 5)
        HauptPnl.Controls.Add(DiamEmailPnl)
        fuehle_diamenontes_felder()
    End Sub
    Private Sub fuehle_diamenontes_felder()
        Dim mailadapter As New dbhotelDataSetTableAdapters.MailTableAdapter

        mailadapter.Fill(Me.DbhotelDataSet.Mail)
        If Me.DbhotelDataSet.Mail.Count >= 3 Then
            If Not IsDBNull(Me.DbhotelDataSet.Mail(7).Item("subject")) Then
                diamEmailSubjTbx.Text = Me.DbhotelDataSet.Mail(7).subject
            Else
                diamEmailSubjTbx.Text = ""
            End If
            If Not IsDBNull(Me.DbhotelDataSet.Mail(7).Item("body")) Then
                diamEmailRtb.Text = Me.DbhotelDataSet.Mail(7).body
            Else
                diamEmailRtb.Text = ""
            End If
            If Not IsDBNull(Me.DbhotelDataSet.Mail(7).Item("attachment")) Then
                diamEmailAttTbx.Text = Me.DbhotelDataSet.Mail(7).attachment
            Else
                diamEmailAttTbx.Text = ""
            End If
    ...
    End Sub
    Private Sub diamenontes_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles diamEmailBtn.Click
        'Using connection As New OleDb.OleDbConnection(connectionString)
        '    Dim command As New OleDb.OleDbCommand()
        '    'Dim myReader As OleDb.OleDbDataReader
        '    connection.Open()
        '    command.Connection = connection
        '    command.Parameters.AddWithValue("subject", diamEmailSubjTbx.Text)
        '    command.Parameters.AddWithValue("body", diamEmailRtb.Text)
        '    command.Parameters.AddWithValue("attacment", diamEmailAttTbx.Text)
        '    command.CommandText = "UPDATE Mail SET subject=?,body=?, attachment=? WHERE (kwd=8)" '  FROM parastatika INNER JOIN afm ON parastatika.etaireia=afm.kwd WHERE (parastatika.kwd=?)" 'and (identifikation=?)
        '    command.ExecuteNonQuery()
        '    ' Always call Read before accessing data.
        'End Using
        Using connection As New SqlConnection(connectionString)
            ...
            command.Parameters.AddWithValue("@subject", diamEmailSubjTbx.Text)
            command.Parameters.AddWithValue("@body", diamEmailRtb.Text)
            command.Parameters.AddWithValue("@attachment", diamEmailAttTbx.Text)
            command.CommandText = "UPDATE Mail SET subject=@subject, body=@body, attachment=@attachment WHERE kwd=8"
    ...
    '            command.Parameters.AddWithValue("gananti", PraktoreiaDataGridView.Item(2, i).Value)
    '            command.Parameters.AddWithValue("Kwd", PraktoreiaDataGridView.Item(0, i).Value)
    '            command.CommandText = "UPDATE praktoreia SET garanti=? WHERE kwd=?"
    '            command.ExecuteNonQuery()
    ...
    Private Sub ToolStripButton28_Click(sender As Object, e As EventArgs) Handles ToolStripButton28.Click
        ...
        Using connection As New SqlConnection(connectionString)
            ...
            For i = 0 To PraktoreiaBindingSource.Count - 1
                command.Parameters.AddWithValue("@garanti", PraktoreiaDataGridView.Item(2, i).Value)
                command.Parameters.AddWithValue("@kwd", PraktoreiaDataGridView.Item(0, i).Value)
                command.CommandText = "UPDATE praktoreia SET garanti=@garanti WHERE kwd=@kwd"
                command.ExecuteNonQuery()
                command.Parameters.Clear()
            Next
        End Using
    ...
    Private Sub diamEmailBtn_Click(sender As Object, e As EventArgs) Handles diamEmailBtn.Click
