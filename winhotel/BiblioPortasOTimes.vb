...
Public Class BiblioPortasOTimes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.BiblioPortasOTimes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBiblioPortasOTimes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BiblioPortasOTimes = New BiblioPortasOTimes()
        rpt.Site = Me.Site
        Return rpt
    End Function
