...
Public Class AllotmentPrakt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.AllotmentPrakt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAllotmentPrakt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AllotmentPrakt = New AllotmentPrakt()
        rpt.Site = Me.Site
        Return rpt
    End Function
