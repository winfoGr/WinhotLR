...
Public Class ProblEsodaDwmPrakt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.ProblEsodaDwmPrakt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProblEsodaDwmPrakt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ProblEsodaDwmPrakt = New ProblEsodaDwmPrakt()
        rpt.Site = Me.Site
        Return rpt
    End Function
