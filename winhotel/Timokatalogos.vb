...
Public Class Timokatalogos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.Timokatalogos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTimokatalogos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Timokatalogos = New Timokatalogos()
        rpt.Site = Me.Site
        Return rpt
    End Function
