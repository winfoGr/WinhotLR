...
Public Class StatusPraktXenod
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.StatusPraktXenod.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStatusPraktXenod
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StatusPraktXenod = New StatusPraktXenod()
        rpt.Site = Me.Site
        Return rpt
    End Function
