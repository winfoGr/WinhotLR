...
Public Class StatusXenodoxeiou
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.StatusXenodoxeiou.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStatusXenodoxeiou
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StatusXenodoxeiou = New StatusXenodoxeiou()
        rpt.Site = Me.Site
        Return rpt
    End Function
