...
Public Class TeloiDiamonwn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.TeloiDiamonwn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTeloiDiamonwn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TeloiDiamonwn = New TeloiDiamonwn()
        rpt.Site = Me.Site
        Return rpt
    End Function
