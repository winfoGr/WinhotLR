...
Public Class SigkTimologiwn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.SigkTimologiwn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSigkTimologiwn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SigkTimologiwn = New SigkTimologiwn()
        rpt.Site = Me.Site
        Return rpt
    End Function
