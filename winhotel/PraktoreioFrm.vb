Public Class PraktoreioFrm
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            If Not (String.IsNullOrEmpty(TextBox14.Text) Or String.IsNullOrEmpty(TextBox8.Text) Or String.IsNullOrEmpty(TextBox6.Text)) Then
                Me.PraktoreiaTableAdapter.UpdatPraktoLeptomereies(Me.TextBox1.Text, Me.TextBox2.Text, Me.TextBox3.Text, Me.TextBox4.Text, Me.TextBox5.Text, Me.TextBox6.Text,
           Me.TextBox7.Text, Me.TextBox8.Text, Me.TextBox9.Text, Me.CheckBox1.Checked, Me.TextBox10.Text, Me.DbhotelDataSet.xrewseis(Me.ComboBox1.SelectedIndex).kwd,
           Me.CheckBox2.Checked, Me.TextBox11.Text, Me.TextBox12.Text, Me.TextBox13.Text, Me.TextBox14.Text, TextBox15.Text, CType(kwdTbx.Text, Int16), Me.SelfCheck3.Checked, kwdikos)
                MsgBox("Το πρακτορείο αποθηκεύτηκε!", MsgBoxStyle.Information, "winfo\nikEl.")
            Else
                MsgBox("ΑΦΜ - Ταχυδρομικός Κώδικας - Πόλη είναι απαραίτητα!", MsgBoxStyle.Information, "winfo\nikEl.")
            End If


        Catch ex1 As IndexOutOfRangeException
            MsgBox("ÅðéëÝîôå ôýðï ÷ñÝùóçò !", MsgBoxStyle.Exclamation, "winfo\nikEl.")
            Me.ComboBox1.Focus()
        Catch ex2 As OleDb.OleDbException
            MsgBox("Ç ÁðïèÞêåõóç äåí êáôÝóôç äõíáôÞ. ÅëÝãîôå ôïí êùäéêü !", MsgBoxStyle.Exclamation, "winfo\nikEl.")
        Catch ex3 As InvalidCastException
            MsgBox("Ç ÁðïèÞêåõóç äåí êáôÝóôç äõíáôÞ. O Kùäéêüò ðñÝðåé íá åßíáé áñéèìüò !", MsgBoxStyle.Exclamation, "winfo\nikEl.")
        End Try
    End Sub
    ...
    Private Sub TextBox8_TextLeave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox8.Leave
        ...
        If Not afmclass.ist_afm_ok(Me.TextBox8.Text) Then
            MsgBox("ËÜèïò Á.Ö.Ì. !", MsgBoxStyle.Exclamation, "winfo\nikEl.")
        End If
    End Sub
    ...
    '        Else
    '            MsgBox("Ï Êùäéêüò Ëïãáñéáóìïý ðñÝðåé íá ðåñéÝ÷åé 10 íïýìåñá!", MsgBoxStyle.Exclamation, "winfo\nikEl.")
    '            TextBox10.Clear()
    '            'TextBox10.Focus()

    '        End If
    '    Catch ex As InvalidCastException
    '        MsgBox("Ï Êùäéêüò Ëïãáñéáóìïý ðñÝðåé íá ðåñéÝ÷åé ìüíï íïýìåñá!", MsgBoxStyle.Exclamation, "winfo\nikEl.")
    '        TextBox10.Clear()
    '        'TextBox10.Focus()
