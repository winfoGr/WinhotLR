...
Public Class AnamenAfixeis15
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.AnamenAfixeis15.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAnamenAfixeis15
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AnamenAfixeis15 = New AnamenAfixeis15()
        rpt.Site = Me.Site
        Return rpt
    End Function
