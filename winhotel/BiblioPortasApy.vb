...
Public Class BiblioPortasApy
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.BiblioPortasApy.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBiblioPortasApy
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BiblioPortasApy = New BiblioPortasApy()
        rpt.Site = Me.Site
        Return rpt
    End Function
