...
Public Class EsodaSigkrisi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.EsodaSigkrisi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEsodaSigkrisi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EsodaSigkrisi = New EsodaSigkrisi()
        rpt.Site = Me.Site
        Return rpt
    End Function
