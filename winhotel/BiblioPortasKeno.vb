...
Public Class BiblioPortasKeno
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.BiblioPortasKeno.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_onoma() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedBiblioPortasKeno
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BiblioPortasKeno = New BiblioPortasKeno()
        rpt.Site = Me.Site
        Return rpt
    End Function
