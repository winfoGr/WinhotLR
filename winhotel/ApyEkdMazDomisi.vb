...
Public Class ApyEkdMazDomisi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.ApyEkdMazDomisi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedApyEkdMazDomisi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ApyEkdMazDomisi = New ApyEkdMazDomisi
        rpt.Site = Me.Site
        Return rpt
    End Function
