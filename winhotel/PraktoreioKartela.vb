...
Public Class PraktoreioKartela
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.PraktoreioKartela.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPraktoreioKartela
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PraktoreioKartela = New PraktoreioKartela()
        rpt.Site = Me.Site
        Return rpt
    End Function
