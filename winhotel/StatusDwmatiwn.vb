...
Public Class StatusDwmatiwn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.StatusDwmatiwn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStatusDwmatiwn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StatusDwmatiwn = New StatusDwmatiwn()
        rpt.Site = Me.Site
        Return rpt
    End Function
