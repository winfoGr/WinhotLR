...
Public Class ExtraParastEkt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.ExtraParastEkt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedExtraParastEkt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ExtraParastEkt = New ExtraParastEkt()
        rpt.Site = Me.Site
        Return rpt
    End Function
