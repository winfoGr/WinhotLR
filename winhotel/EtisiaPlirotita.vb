...
Public Class EtisiaPlirotita
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.EtisiaPlirotita.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEtisiaPlirotita
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EtisiaPlirotita = New EtisiaPlirotita()
        rpt.Site = Me.Site
        Return rpt
    End Function
