...
Public Class GrammEispraksis
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.GrammEispraksis.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGrammEispraksis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GrammEispraksis = New GrammEispraksis
        rpt.Site = Me.Site
        Return rpt
    End Function
