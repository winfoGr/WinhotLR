...
Public Class StatusPraktoreiwn
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.StatusPraktoreiwn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStatusPraktoreiwn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StatusPraktoreiwn = New StatusPraktoreiwn
        rpt.Site = Me.Site
        Return rpt
    End Function
