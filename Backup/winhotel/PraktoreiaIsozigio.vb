...
Public Class PraktoreiaIsozigio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.PraktoreiaIsozigio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPraktoreiaIsozigio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PraktoreiaIsozigio = New PraktoreiaIsozigio
        rpt.Site = Me.Site
        Return rpt
    End Function
