Public Class ProblEisprakseis
    ...
    Private Sub ProblEisprBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ProblEisprBtn.Click
        ...
        If ist_pwd_ok(Trim(pswdTbx.Text)) Then
            If VilesRdb.Checked Then
                Me.KratiseisTableAdapter.FillProblepsiEispakseisDwmByEtosAnaxAfixi(Me.DbhotelDataSet.kratiseis, imeromErgasias.Year, apoPck.Value.Date, mexriPck.Value.Date)
            ...
            Else
                ...
                Me.KratiseisTableAdapter.FillProblepsiEispPraktByEtosAnaxAfix(Me.DbhotelDataSet.kratiseis, imeromErgasias.Year, apoPck.Value.Date, mexriPck.Value.Date)
    ...
    Private Function get_onoma_etaireia(ByVal kwd As Integer) As String
        ...
        For j = 0 To Me.DbhotelDataSet.afm.Count - 1
            If Me.DbhotelDataSet.afm(j).kwd = kwd Then
                Return Me.DbhotelDataSet.afm(j).epixirisi
            End If
        Next
        Return ""
    End Function
