Public Class SimfoniesFrm
        ...
        Do Until laufindex > Me.DbhotelDataSet.times_ekt_join.Count - 1 'ola ta eintraege durchlaufen
            ...
            If laufindex + 1 <= Me.DbhotelDataSet.times_ekt_join.Count - 1 Then
                ...
                While Me.DbhotelDataSet.times_ekt_join(laufindex).praktoreio = Me.DbhotelDataSet.times_ekt_join(laufindex + countGroup).praktoreio
                    ...
                    If Me.DbhotelDataSet.times_ekt_join(laufindex).tipos <> Me.DbhotelDataSet.times_ekt_join(laufindex + countGroup).tipos OrElse _
                           Me.DbhotelDataSet.times_ekt_join(laufindex).aasimbolaiou <> Me.DbhotelDataSet.times_ekt_join(laufindex + countGroup).aasimbolaiou OrElse _
                                   Me.DbhotelDataSet.times_ekt_join(laufindex).xrewsi <> Me.DbhotelDataSet.times_ekt_join(laufindex + countGroup).xrewsi OrElse _
        ...
        Do Until startIndex > Me.DbhotelDataSet.bookingpos.Count - 1
            ...
            If startIndex < Me.DbhotelDataSet.bookingpos.Count - 1 Then
                While Me.DbhotelDataSet.bookingpos(startIndex).simbolaio = Me.DbhotelDataSet.bookingpos(startIndex + countIndex).simbolaio
                    ...
                    If Me.DbhotelDataSet.bookingpos(startIndex).klines = Me.DbhotelDataSet.bookingpos(startIndex + countIndex).klines AndAlso _
                    Me.DbhotelDataSet.bookingpos(startIndex).tipos = Me.DbhotelDataSet.bookingpos(startIndex + countIndex).tipos AndAlso _
            ...
            For j = Me.DbhotelDataSet.bookingpos(start + z - 1).apo.Date.Month To Me.DbhotelDataSet.bookingpos(start + z - 1).mexri.Date.Month
                For i = 1 To 31
                    If (j = 2 And i = 31) OrElse (j = 2 And i = 30) OrElse (j = 4 And i = 31) _
                        ...
                        Exit For
                    End If
                    If (Not j = Me.DbhotelDataSet.bookingpos(start + z - 1).apo.Month Or Not i < Me.DbhotelDataSet.bookingpos(start + z - 1).apo.Day) And _
        ...
        Do Until startIndex > Me.DbhotelDataSet.allotment.Count - 1
            ...
            If startIndex < Me.DbhotelDataSet.allotment.Count - 1 Then
                While Me.DbhotelDataSet.allotment(startIndex).simbolaio = Me.DbhotelDataSet.allotment(startIndex + countIndex).simbolaio
                    'MsgBox(Me.DbhotelDataSet.allotment(startIndex).klines)
                    'MsgBox(Me.DbhotelDataSet.allotment(startIndex).tipos)
                    If Me.DbhotelDataSet.allotment(startIndex).klines = Me.DbhotelDataSet.allotment(startIndex + countIndex).klines AndAlso _
                    Me.DbhotelDataSet.allotment(startIndex).tipos = Me.DbhotelDataSet.allotment(startIndex + countIndex).tipos AndAlso _
            ...
            For j = Me.DbhotelDataSet.allotment(start + z - 1).apo.Date.Month To Me.DbhotelDataSet.allotment(start + z - 1).mexri.Date.Month
                For i = 1 To 31
                    If (j = 2 And i = 31) OrElse (j = 2 And i = 30) OrElse (j = 4 And i = 31) _
                        ...
                        Exit For
                    End If
                    If (Not j = Me.DbhotelDataSet.allotment(start + z - 1).apo.Month Or Not i < Me.DbhotelDataSet.allotment(start + z - 1).apo.Day) And _
    ...
    Private Sub AddTimesBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AddTimesBtn.Click
        ...
        If ok Then
            ...
            If currentsimfonia = -1 Then
                ...
                Me.SimfoniesTableAdapter.InsertSimfonia(simbolaiokwd, maxAA, simftipos, simfseason, PrwinTbx.Text, GeumTbx.Text, DeipnTbx.Text, TextBox10.Text, TextBox13.Text, _
                TextBox14.Text, TextBox15.Text, TextBox16.Text, TextBox19.Text, TextBox18.Text, TextBox17.Text, TextBox20.Text, TextBox21.Text, TextBox22.Text, _
            ...
            Else
                ...
                Me.SimfoniesTableAdapter.UpdateSimfonia(simbolaiokwd, maxAA, simftipos, simfseason, PrwinTbx.Text, GeumTbx.Text, DeipnTbx.Text, TextBox10.Text, TextBox13.Text, _
                TextBox14.Text, TextBox15.Text, TextBox16.Text, TextBox19.Text, TextBox18.Text, TextBox17.Text, TextBox20.Text, TextBox21.Text, TextBox22.Text, _
    ...
    Private Sub TextBoxen_Leave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox10.Leave, TextBox13.Leave, TextBox14.Leave, _
    ...
    End Sub
    Private Sub TextBoxen_click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox10.Click, TextBox13.Click, TextBox14.Click, _
   TextBox15.Click, TextBox16.Click, TextBox17.Click, TextBox18.Click, TextBox19.Click, TextBox20.Click, TextBox21.Click, TextBox22.Click, TextBox23.Click, TextBox24.Click, TextBox25.Click
            ...
            For j = Me.DbhotelDataSet.bookingpos(z).apo.Date.Month To Me.DbhotelDataSet.bookingpos(z).mexri.Date.Month
                For i = 1 To 31
                    If (j = 2 And i = 31) OrElse (j = 2 And i = 30) OrElse (j = 4 And i = 31) _
                        ...
                        Exit For
                    End If
                    If (Not j = Me.DbhotelDataSet.bookingpos(z).apo.Month Or Not i < Me.DbhotelDataSet.bookingpos(z).apo.Day) And _
        ...
        For j = firstdatumAllotm.Date.Month To lastdatumAllotm.Date.Month
            ...
            For i = 1 To 31
                ...
                OrElse (j = 6 And i = 31) OrElse (j = 9 And i = 31) OrElse (j = 11 And i = 31) Then
                    ...
                    Exit For
                End If
                If (Not j = firstdatumAllotm.Date.Month Or Not i < firstdatumAllotm.Date.Day) And _
        ...
        For j = firstdatum.Date.Month To lastdatum.Date.Month
            ...
            For i = 1 To 31
                ...
                OrElse (j = 6 And i = 31) OrElse (j = 9 And i = 31) OrElse (j = 11 And i = 31) Then
                    ...
                    Exit For
                End If
                If (Not j = firstdatum.Date.Month Or Not i < firstdatum.Date.Day) And _
            ...
            For j = Me.DbhotelDataSet.allotment(z).apo.Date.Month To Me.DbhotelDataSet.allotment(z).mexri.Date.Month
                For i = 1 To 31
                    If (j = 2 And i = 31) OrElse (j = 2 And i = 30) OrElse (j = 4 And i = 31) _
                        ...
                        Exit For
                    End If
                    If (Not j = Me.DbhotelDataSet.allotment(z).apo.Month Or Not i < Me.DbhotelDataSet.allotment(z).apo.Day) And _
        ...
        If KlinsCbx.SelectedIndex <> -1 Then
            ...
            ElseIf TipiCbx.SelectedIndex > 0 And KlinsCbx.SelectedIndex = 0 Then '0Y=> DEN IPARXI 00 AND DEN YPARXEI iY OPOU i=OLES OI KLINES EKTOS TOU O('OLES')
                ...
                If eintr = 0 Then
                    ...
                    AllotmRB.Enabled = False
                Else
                    count1 = Me.AllotmentTableAdapter.ExistKlinesTiposBySimbolaio(simbolaiokwd, 0, 0, False)
                    count2 = Me.AllotmentTableAdapter.ExistKlinesBySimbolaio(simbolaiokwd, 0, tipos, False)
                    ...
                    count1 = Me.AllotmentTableAdapter.ExistKlinesTiposBySimbolaio(simbolaiokwd, 0, 0, True)
                    count2 = Me.AllotmentTableAdapter.ExistKlinesBySimbolaio(simbolaiokwd, 0, tipos, True)
                    If count1 = 0 And count2 = 0 Then
                        GuaraRB.Enabled = True
                        'AllotmRB.Enabled = True
                        GuaraRB.Checked = False
            ...
            ElseIf KlinsCbx.SelectedIndex > 0 And TipiCbx.SelectedIndex = 0 Then 'XO=> den iparxei 00 and den iparxei Xi opou I=oloi oi tipoi ektos 0
                ...
                Else
                    count1 = Me.AllotmentTableAdapter.ExistKlinesTiposBySimbolaio(simbolaiokwd, 0, 0, False)
                    count2 = Me.AllotmentTableAdapter.ExistTiposBySimbolaio(simbolaiokwd, 0, klines, False)
                    If count1 = 0 And count2 = 0 Then
                        'GuaraRB.Enabled = True
                        AllotmRB.Enabled = True
                        'GuaraRB.Checked = False
                    ...
                    End If
                    count1 = Me.AllotmentTableAdapter.ExistKlinesTiposBySimbolaio(simbolaiokwd, 0, 0, True)
                    count2 = Me.AllotmentTableAdapter.ExistTiposBySimbolaio(simbolaiokwd, 0, klines, True)
                    If count1 = 0 And count2 = 0 Then
                        GuaraRB.Enabled = True
                        'AllotmRB.Enabled = True
                        GuaraRB.Checked = False
            ...
            ElseIf KlinsCbx.SelectedIndex = 0 And TipiCbx.SelectedIndex = 0 Then 'OO=> den iparxei i klines (i<>0) kai den iparxei i tipos(i<>0)
                ...
                Else
                    ...
                    Else
                        ...
                        AllotmRB.Enabled = False
                    End If
                    count1 = Me.AllotmentTableAdapter.ExistKlinesByOO(simbolaiokwd, klines, True)
                    count2 = Me.AllotmentTableAdapter.ExistTiposByOO(simbolaiokwd, tipos, True)
                    If count1 = 0 And count2 = 0 Then
                        GuaraRB.Enabled = True
                        'AllotmRB.Enabled = True
                        GuaraRB.Checked = False
    ...
    Private Sub praktoreia_zeig()
        ...
        InfoLbl.TextAlign = ContentAlignment.MiddleCenter
        InfoLbl.ForeColor = Color.Black
        InfoLbl.Text = "<Για να δείτε τις Λεπτομέρειες Πρακτορείου κάνετε διπλό κλίκ πάνω του>" & vbCrLf & _
        "<(Για ευκολότερη ανεύρεση ενός Πρακτορείου μπορείτε να ταξινομίσετε την λίστα αλφαβητικά κάνωντας απλό κλίκ στην επικεφάλίδα της στήλης ΕΠΩΝΥΜΙΑ>" & vbCrLf & _
        "<Εισάγετε νέο πρακτορείο στο τέλος της λίστας και αποθηκεύστε πατώντας το αντίστοιχο εικονίδιο της Δισκέτας.>" & vbCrLf & _
            ...
            Try
                ...
                Else
                    If Not PraktoreiaDataGridView.Item(1, i).Value.ToString.Equals("") And Not PraktoreiaDataGridView.Item(0, i).Value.ToString.Equals("") Then
                        Try
                            Me.PraktoreiaTableAdapter.InsertPraktoreia(PraktoreiaDataGridView.Item(1, i).Value, PraktoreiaDataGridView.Item(0, i).Value)
