...
Public Class BiblioKinisis
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.BiblioKinisis.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBiblioKinisis
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BiblioKinisis = New BiblioKinisis
        rpt.Site = Me.Site
        Return rpt
    End Function
