Public Class KratiseisSucheF
    ...
    'End Sub
    Public Sub New(ByVal imerominia As Date, ByVal check1 As Boolean, ByVal check2 As Boolean, ByVal aufruf As Byte)
        ...
        If status = 2 Then 'aufruf apo mem timologia
            Me.KratiseisenilikesTableAdapter.FillByEtosStatusTimologioAnaxwrisi(Me.DbhotelDataSet.kratiseisenilikes, etos, checkIn, checkOut, 0, imeromErgasias)

        ElseIf status = 1 Then
            Me.KratiseisenilikesTableAdapter.FillByEtosStatus(Me.DbhotelDataSet.kratiseisenilikes, etos, checkIn, checkOut)
        ElseIf status = 3 Then
            ...
            Me.KratiseisenilikesTableAdapter.FillJoinLogariasmoidiamenwnByEtosCheckinChkout(Me.DbhotelDataSet.kratiseisenilikes, etos, checkIn, checkOut, 0)
            Me.TextBox1.Enabled = False
            TextBox2.Enabled = False
            TextBox4.Enabled = False
        End If
    End Sub
    Public Sub New(ByVal imerominia As Date, ByVal check1 As Boolean, ByVal check2 As Boolean, ByVal dwm As String, ByVal aufruf As Byte)
        ' This call is required by the Windows Form Designer.
        InitializeComponent()
        imeromErgasias = imerominia
        etos = imerominia.Year
        ...
        If status = 2 Then
            Me.KratiseisenilikesTableAdapter.FillByDwmatioEtosStatusTimologio(Me.DbhotelDataSet.kratiseisenilikes, dwm, etos, checkIn, checkOut, 0)
        ElseIf status = 1 Then
            Me.KratiseisenilikesTableAdapter.FillByDwmatioEtosStatus(Me.DbhotelDataSet.kratiseisenilikes, dwm, etos, checkIn, checkOut)
        ElseIf status = 3 Then
            Me.KratiseisenilikesTableAdapter.FillJoinLogarisndiamenByDwmatioEtosChkinAAgram(Me.DbhotelDataSet.kratiseisenilikes, dwm, etos, True, False, 0)
        End If
        ...
        If KratiseisenilikesDataGridView.RowCount <> 0 Then
            ...
            Try
                ...
                If kwdikoKratisisDB <> Nothing Then
                    If Me.KratiseisenilikesTableAdapter.ExistKratisi(KratiseisenilikesDataGridView.Item(0, KratiseisenilikesDataGridView.CurrentRow.Index).Value) Then
                        'MsgBox(praktkwd)
    ...
    Private Sub TextBox3_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox3.TextChanged
        ...
        s = "%" & LTrim(sender.text) & "%"
        If status = 1 Then
            Me.KratiseisenilikesTableAdapter.FillByOnomaEtosStatus(Me.DbhotelDataSet.kratiseisenilikes, s, etos, checkIn, checkOut)
        ElseIf status = 2 Then
            Me.KratiseisenilikesTableAdapter.FillByOnomaEtosStatusTimol(Me.DbhotelDataSet.kratiseisenilikes, s, etos, checkIn, checkOut, 0)
        ElseIf status = 3 Then
            Me.KratiseisenilikesTableAdapter.FillJoinLogariasmdiamenByOnomaEtosChkinChkout(Me.DbhotelDataSet.kratiseisenilikes, s, etos, checkIn, checkOut, 0)
        End If
    ...
    Private Sub TextBox4_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox4.TextChanged
        ...
        s = LTrim(sender.text) & "%"
        If status = 1 Then
            Me.KratiseisenilikesTableAdapter.FillByVoucherBiblPortasEtosStatus(Me.DbhotelDataSet.kratiseisenilikes, s, etos, checkIn, checkOut)
        ElseIf status = 2 Then
            Me.KratiseisenilikesTableAdapter.FillByVoucherBiblPortasEtosStatusTimol(Me.DbhotelDataSet.kratiseisenilikes, s, etos, checkIn, checkOut, 0)
        End If
    ...
    Private Sub Button13_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button13.Click
        ...
        Try
            ...
            If status = 1 Then
                Me.KratiseisenilikesTableAdapter.FilByArithmEtosStatus(Me.DbhotelDataSet.kratiseisenilikes, arKratisis, etos, checkIn, checkOut)
            ElseIf status = 2 Then
                Me.KratiseisenilikesTableAdapter.FillByArithEtosStatusTimol(Me.DbhotelDataSet.kratiseisenilikes, arKratisis, etos, checkIn, checkOut, 0)
            End If
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        If Not LTrim(TextBox2.Text).Equals("") Then
            If status = 1 Then
                Me.KratiseisenilikesTableAdapter.FillByDwmatioEtosStatus(Me.DbhotelDataSet.kratiseisenilikes, LTrim(TextBox2.Text), etos, checkIn, checkOut)
            ElseIf status = 2 Then
                Me.KratiseisenilikesTableAdapter.FillByDwmatioEtosStatusTimologio(Me.DbhotelDataSet.kratiseisenilikes, LTrim(TextBox2.Text), etos, checkIn, checkOut, 0)
            End If
        End If
    End Sub
