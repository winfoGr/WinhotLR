...
Public Class KleisimoHmeras
    ...
    Private Sub fuehle_ekd_apy_cbx()
        ...
        For j = 0 To Me.DbhotelDataSet.afm.Count
            ...
            Else
                apyEkdCbx.Items.Add(Me.DbhotelDataSet.afm(j - 1).epixirisi)
            End If
        ...
        If Me.DbhotelDataSet.ekt_apy_mem.Count <> 0 Then
            ...
            Using connection As New OleDb.OleDbConnection(connectionString)
                ...
                Try
                    ...
                    command.Parameters.AddWithValue("praktoreio", Me.DbhotelDataSet.katastasiapy(firstIndex).praktimologio)
                    command.Parameters.AddWithValue("simbolaio", simbKrat) 'Me.DbhotelDataSet.kratiseis(0).dwmatio
                    command.Parameters.AddWithValue("eponimia", Me.DbhotelDataSet.ekt_apy_diafora(Me.DbhotelDataSet.ekt_apy_diafora.Count - 1).aitiologia) 'Me.DbhotelDataSet.ekt_apy_diafora(Me.DbhotelDataSet.ekt_apy_diafora.Count - 1).eponimia
                    command.Parameters.AddWithValue("dieuthinsi", Me.DbhotelDataSet.ekt_apy_diafora(Me.DbhotelDataSet.ekt_apy_diafora.Count - 1).address)
                    command.Parameters.AddWithValue("afm", Me.DbhotelDataSet.ekt_apy_diafora(Me.DbhotelDataSet.ekt_apy_diafora.Count - 1).afm_adt)
                    command.Parameters.AddWithValue("doy", Me.DbhotelDataSet.ekt_apy_diafora(Me.DbhotelDataSet.ekt_apy_diafora.Count - 1).doy)
                    ...
                    command.Parameters.AddWithValue("prokataboli", sumProkat)
                    command.Parameters.AddWithValue("simetoxi", sumSimet)
                    command.Parameters.AddWithValue("ypoloipon", Me.DbhotelDataSet.ekt_apy_diafora(Me.DbhotelDataSet.ekt_apy_diafora.Count - 1).ypoloipon)
                    'If (PliromCbx.SelectedItem) = Nothing Then
                    pliromi = "Επί Πιστώση"
                    'End If
                    command.Parameters.AddWithValue("pliromi", pliromi)
                    command.Parameters.AddWithValue("dimforos", Me.DbhotelDataSet.ekt_apy_diafora(Me.DbhotelDataSet.ekt_apy_diafora.Count - 1).dim_foros)
                    ...
                    command.Parameters.AddWithValue("mauro", ist_mauri_etaireia(parastatiko))
                    ...
                    " pliromi, dimforos, false, false, false, true, mauro, identifikation)"
                    ...
                    For j = firstIndex To firstIndex + countIndex - 1
                        ...
                        If kwdKratTemp <> Me.DbhotelDataSet.katastasiapy(j).kwd Then
                            ...
                            command.Parameters.AddWithValue("parastatiko", parastatiko)
                            command.Parameters.AddWithValue("kwd", Me.DbhotelDataSet.katastasiapy(j).kwd)
  ...
  EthnAnzTbx1.Click, EthnAnzTbx2.Click, SimetTbx.Click, ProkatTbx.Click, KratisiTbx.Click, PaidiTbx3.Click
            ...
            If response = MsgBoxResult.Yes Then
                Me.NonshowkratiseisTableAdapter.InsertNonShowKratisi(ImeromKratTbx.Text, etos, Me.DbhotelDataSet.kratiseis(0).arithmos, Me.DbhotelDataSet.kratiseis(0).simbolaio, _
                     ...
                     Me.DbhotelDataSet.kratiseis(0).ethnikotites, Me.DbhotelDataSet.kratiseis(0).anzethnikotites, Me.DbhotelDataSet.kratiseis(0).ethnikotites2, Me.DbhotelDataSet.kratiseis(0).anzethnikotites2, _
                      Me.DbhotelDataSet.kratiseis(0).afixi, Me.DbhotelDataSet.kratiseis(0).anaxwrisi, currentklines, currenttipos, Me.DbhotelDataSet.kratiseis(0).guarantie, Me.DbhotelDataSet.kratiseis(0).dwmatio, _
    ...
    Private Sub BiblPortasBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BiblPortasBtn.Click
        ...
        Dim biblioPortas As New BiblioPortasFormclass(imeromErgasias, MorfiRdb1.Checked, TheorimRdb.Checked, 2)
    ...
    Private Sub kleisimo_imeras()
        ...
        KleisimoPnl.Size = New Point(405, 223)
    ...
    Private Function fuhre_kleisimo_imeras_aus() As Boolean
        ...
        If KleisimoPck1.Value > imeromErgasias AndAlso Me.DbhotelDataSet.etaireia(0).imeromergasias = imeromErgasias Then
            ...
            countKrat = Me.KratiseisTableAdapter.GetAkopesAnaxwriseisByImerTimologiostatus(CType(KleisImerErgLbl.Text, Date), 0, False)
            If countKrat <> 0 Then
                Me.EtaireiaTableAdapter.SetFlagsEktiposewn(0, 0, imeromErgasias)
    ...
    Private Sub daysbeforeTbx_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles daysbeforeTbx.Leave
        Try
    ...
    Private Sub SendMailto()
        ...
        anaxadapter.FillAnaxMailByAnaxChkout(Me.DbhotelDataSet.AfixeisAnaxwriseis1, datum, True)
                    ...
                    If Not Me.DbhotelDataSet.AfixeisAnaxwriseis1(j).voucher.Equals(mailTemp) Then
                        ...
                        If Me.DbhotelDataSet.links.Count <> 0 Then
                            If Not IsDBNull(Me.DbhotelDataSet.links(0).Item("link")) And Not IsDBNull(Me.DbhotelDataSet.links(0).Item("description")) Then
                                body = "Dear Mrs./Mr. " + name + "," + ChrW(13) + ChrW(13) + Me.DbhotelDataSet.Mail(0).body + ChrW(13) + ChrW(13) + Me.DbhotelDataSet.links(0).description + ChrW(13) + _
                          Me.DbhotelDataSet.links(0).link
                            Else
                                body = "Dear Mrs./Mr. " + name + "," + ChrW(13) + ChrW(13) + Me.DbhotelDataSet.Mail(0).body
                            End If
                        Else
                            body = "Dear Mrs./Mr. " + name + "," + ChrW(13) + ChrW(13) + Me.DbhotelDataSet.Mail(0).body
                        End If
    ...
    End Sub
    Private Sub SendMailDirections()
        ...
        anaxadapter.AfixeisByEtosImerom_(Me.DbhotelDataSet.AfixeisAnaxwriseis2, etos, datum, datum, datum, datum, etos, datum, datum, datum, datum)
        ...
        Using connection As New OleDb.OleDbConnection(connectionString)
            ...
            Try
                ...
                For j = 0 To delKrat.Length - 1
                    ...
                    command.CommandText = "DELETE FROM biblioportas WHERE (imerominia>=?) and (status=2) and (kratisi=?)and (arapy<>0)" '
                    command.ExecuteNonQuery()
                    command.Parameters.Clear()
                    command.Parameters.AddWithValue("imerominia", CType(AkyrosiPck2.Value.Date, Date))
                    command.Parameters.AddWithValue("kratisi", delKrat(j))
                    command.CommandText = "UPDATE biblioportas SET flag=0 WHERE (imerominia>=?) and (kratisi=?)"
                    command.ExecuteNonQuery()
                    command.Parameters.Clear()
        ...
        Using connection As New OleDb.OleDbConnection(connectionString)
            ...
            Try
                ...
                For j = 0 To Me.DbhotelDataSet.kratiseis.Count - 1
                    ...
                    command.CommandText = "UPDATE kratiseis SET dwmatio=?, checkin=false WHERE (kwd=?)"
                    command.ExecuteNonQuery()
                    command.Parameters.Clear()
    ...
    Private Function ist_imeromergasias_aktuel(ByVal connectionString As String) As Boolean
        Using connection As New OleDb.OleDbConnection(connectionString)
            ...
            command.CommandText = "SELECT MAX(imerominia) FROM biblioportas where (etos=?)"
    ...
    Private Sub make_ektiposi_dataset_section_1(ByVal startIndex As Int16, ByVal stepsIndex As Int16, ByVal onomTemp As String())
        ...
        Me.DbhotelDataSet.ekt_main_courante(Me.DbhotelDataSet.ekt_main_courante.Count - 1).synolo = Me.DbhotelDataSet.main_curante(startIndex + stepsIndex - 1).ypnos + Me.DbhotelDataSet.main_curante(startIndex + stepsIndex - 1).prwino + _
    ...
    Private Sub this_year_ektiposi()
        ...
        For j = 0 To Me.DbhotelDataSet.timologioanalysis.Count - 1
            ...
            Me.DbhotelDataSet.ekt_imeras_dr(0).geumata21 = Me.DbhotelDataSet.ekt_imeras_dr(0).geumata21 + Me.DbhotelDataSet.timologioanalysis(j).geuma + Me.DbhotelDataSet.timologioanalysis(j).geumafpa + _
        ...
        For j = 0 To Me.DbhotelDataSet.timologioanalysis.Count - 1
            ...
            Me.DbhotelDataSet.ekt_mina_dr(0).geumata21 = Me.DbhotelDataSet.ekt_mina_dr(0).geumata21 + Me.DbhotelDataSet.timologioanalysis(j).geuma + Me.DbhotelDataSet.timologioanalysis(j).geumafpa + _
            Me.DbhotelDataSet.timologioanalysis(j).deipno + Me.DbhotelDataSet.timologioanalysis(j).deipnofpa
        ...
        For j = 0 To Me.DbhotelDataSet.timologioanalysis.Count - 1
            ...
            Me.DbhotelDataSet.ekt_etos_dr(0).geumata21 = Me.DbhotelDataSet.ekt_etos_dr(0).geumata21 + Me.DbhotelDataSet.timologioanalysis(j).geuma + Me.DbhotelDataSet.timologioanalysis(j).geumafpa + _
            Me.DbhotelDataSet.timologioanalysis(j).deipno + Me.DbhotelDataSet.timologioanalysis(j).deipnofpa
    ...
    Private Sub last_year_ektiposi()
        ...
        'ta athroismata timologiwn Hmeras(->sto Dataset ta atibute einai ta 21 row 2 spalte1 ean blepw to CR ws pinaka!!!) 
        ...
        For j = 0 To Me.DbhotelDataSet.timologioanalysis.Count - 1
            ...
            Me.DbhotelDataSet.ekt_imeras_dr(0).geumata22 = Me.DbhotelDataSet.ekt_imeras_dr(0).geumata22 + Me.DbhotelDataSet.timologioanalysis(j).geuma + Me.DbhotelDataSet.timologioanalysis(j).geumafpa + _
            Me.DbhotelDataSet.timologioanalysis(j).deipno + Me.DbhotelDataSet.timologioanalysis(j).deipnofpa
        ...
        For j = 0 To Me.DbhotelDataSet.timologioanalysis.Count - 1
            ...
            Me.DbhotelDataSet.ekt_mina_dr(0).geumata22 = Me.DbhotelDataSet.ekt_mina_dr(0).geumata22 + Me.DbhotelDataSet.timologioanalysis(j).geuma + Me.DbhotelDataSet.timologioanalysis(j).geumafpa + _
            Me.DbhotelDataSet.timologioanalysis(j).deipno + Me.DbhotelDataSet.timologioanalysis(j).deipnofpa
        ...
        For j = 0 To Me.DbhotelDataSet.timologioanalysis.Count - 1
            ...
            Me.DbhotelDataSet.ekt_etos_dr(0).geumata22 = Me.DbhotelDataSet.ekt_etos_dr(0).geumata22 + Me.DbhotelDataSet.timologioanalysis(j).geuma + Me.DbhotelDataSet.timologioanalysis(j).geumafpa + _
            Me.DbhotelDataSet.timologioanalysis(j).deipno + Me.DbhotelDataSet.timologioanalysis(j).deipnofpa
