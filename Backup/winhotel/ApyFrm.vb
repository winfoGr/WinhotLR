        ...
        For i = 0 To ApyBindingSource.Count - 1
            Try
                If Me.ApyDataGridView.Item(1, i).Value = 0 Then
                    Me.ApyTableAdapter.InsertApy(kwdikos, LTrim(ApyDataGridView.Item(2, i).Value.ToString), ApyDataGridView.Item(3, i).Value.ToString, ApyDataGridView.Item(4, i).Value.ToString, ApyDataGridView.Item(5, i).Value.ToString, ApyDataGridView.Item(6, i).Value.ToString)
                Else
                    Me.ApyTableAdapter.UpdateApy(LTrim(ApyDataGridView.Item(2, i).Value.ToString), ApyDataGridView.Item(3, i).Value.ToString, ApyDataGridView.Item(4, i).Value.ToString, ApyDataGridView.Item(5, i).Value.ToString, ApyDataGridView.Item(6, i).Value.ToString, ApyDataGridView.Item(0, i).Value.ToString)
                End If
            Catch ex As InvalidCastException
