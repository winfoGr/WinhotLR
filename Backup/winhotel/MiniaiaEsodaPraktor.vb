...
Public Class MiniaiaEsodaPraktor
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "MiniaiaEsodaPraktor.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.MiniaiaEsodaPraktor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMiniaiaEsodaPraktor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MiniaiaEsodaPraktor = New MiniaiaEsodaPraktor
        rpt.Site = Me.Site
        Return rpt
    End Function
