...
Public Class ApyEkdMzDomisi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "winhotel.ApyEkdMzDomisi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedApyEkdMzDomisi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ApyEkdMzDomisi = New ApyEkdMzDomisi
        rpt.Site = Me.Site
        Return rpt
    End Function
